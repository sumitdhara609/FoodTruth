          ...
          return (
            ...
            >
              ...
              <div className="mt-4 flex flex-wrap items-center gap-2">
                <span className="rounded-full border border-[var(--border)] bg-[var(--surface)] px-3 py-1 text-[10px] font-semibold uppercase tracking-[0.16em] text-[var(--foreground)]/42">
                  {sourceContract.label}
                </span>

                <span className="text-[10px] font-medium text-[var(--foreground)]/32">
                  Reviewed label data
                </span>
              </div>
